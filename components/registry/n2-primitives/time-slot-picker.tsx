...
function TimeSlotPicker({
  ...
  return (
    <div
      ...
      data-portal="https://mzizi.dev/components/time-slot-picker"
      className={cn(
        "grid grid-cols-3 gap-2 outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 sm:grid-cols-4",
        className
      )}
      role="listbox"
