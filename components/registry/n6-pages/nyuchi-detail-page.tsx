      ...
      {ctaAction && ctaLabel && (
        <div className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-card/90 px-4 py-3 pb-[env(safe-area-inset-bottom,12px)] backdrop-blur-xl">
          <div className="mx-auto flex max-w-2xl gap-2">
            <button
              onClick={ctaAction}
              className="h-14 flex-1 rounded-full bg-[var(--brand-accent,var(--status-success,var(--color-malachite,#64FFDA)))] text-[15px] font-semibold text-[var(--brand-accent-foreground,#0A0A0A)] transition-opacity hover:opacity-80"
            >
              {ctaLabel}
            </button>
